// Taken from bootloader's FAT implementation, because I didn't feel like re-implementing it myself.
...
impl FileSystem {
    pub fn parse(mut disk: DiskRead) -> Self {
        Self {
...
fn fat_entry_of_nth_cluster(disk: &mut DiskRead, fat_type: FatType, fat_start: u64, n: u32) -> u32 {
    debug_assert!(n >= 2);
    match fat_type {
        FatType::Fat32 => {
            let base = n as u64 * 4;
